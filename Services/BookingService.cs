...
public class BookingService
{
    ...
    {
        // ── Id 1-10 ───────────────────────────────────────────────────────────
        [1] = new() { Id=1,  Name="Alice Bergström",   Email="alice.bergstrom@example.com",
            Phone="070-123 45 67",  PhotoUrl="https://randomuser.me/api/portraits/women/44.jpg",
        ...
        [2] = new() { Id=2,  Name="Björn Lindqvist",   Email="bjorn.lindqvist@example.com",
            Phone="073-987 65 43",  PhotoUrl="https://randomuser.me/api/portraits/men/32.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 3)),
            TheoryStepsByCategory=TheoryCat(("B", 4)) },

        [3] = new() { Id=3,  Name="Cecilia Holm",      Email="cecilia.holm@example.com",
            Phone="070-234 56 78",  PhotoUrl="https://randomuser.me/api/portraits/women/21.jpg",
        ...
        [4] = new() { Id=4,  Name="David Ekström",     Email="david.ekstrom@example.com",
            Phone="076-345 67 89",  PhotoUrl="https://randomuser.me/api/portraits/men/17.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(
        ...
        [5] = new() { Id=5,  Name="Emma Sjöberg",      Email="emma.sjoberg@example.com",
            Phone="076-555 44 33",  PhotoUrl="https://randomuser.me/api/portraits/women/68.jpg",
        ...
        [6] = new() { Id=6,  Name="Filip Gustafsson",  Email="filip.gustafsson@example.com",
            Phone="070-456 78 90",  PhotoUrl="https://randomuser.me/api/portraits/men/55.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 6)),
            TheoryStepsByCategory=TheoryCat(("B", 7)) },

        [7] = new() { Id=7,  Name="Gabriella Nordin",  Email="gabriella.nordin@example.com",
            Phone="072-111 22 33",  PhotoUrl="https://randomuser.me/api/portraits/women/12.jpg",
            LicenseCategories=["AM"],
            TrainingStepsByCategory=Cat(("AM", 0)),
            TheoryStepsByCategory=TheoryCat(("AM", 2)) },

        [8] = new() { Id=8,  Name="Henrik Sandberg",   Email="henrik.sandberg@example.com",
            Phone="073-567 89 01",  PhotoUrl="https://randomuser.me/api/portraits/men/43.jpg",
            LicenseCategories=["B","BE"],
            TrainingStepsByCategory=Cat(
        ...
        [9] = new() { Id=9,  Name="Ida Wallin",        Email="ida.wallin@example.com",
            Phone="070-678 90 12",  PhotoUrl="https://randomuser.me/api/portraits/women/35.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(
                ("B", 7, "Osäker vid backning – behöver mer träning.", 3)),
            TheoryStepsByCategory=TheoryCat(("B", 6)) },

        [10] = new() { Id=10, Name="Jakob Lund",       Email="jakob.lund@example.com",
            Phone="076-789 01 23",  PhotoUrl="https://randomuser.me/api/portraits/men/10.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 4)),
            TheoryStepsByCategory=TheoryCat(("B", 3)) },

        // ── Id 11-20 ──────────────────────────────────────────────────────────
        [11] = new() { Id=11, Name="Karin Magnusson",  Email="karin.magnusson@example.com",
            Phone="070-890 12 34",  PhotoUrl="https://randomuser.me/api/portraits/women/57.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(
        ...
        [12] = new() { Id=12, Name="Lucas Eriksson",   Email="lucas.eriksson@example.com",
            Phone="073-901 23 45",  PhotoUrl="https://randomuser.me/api/portraits/men/28.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 5)),
            TheoryStepsByCategory=TheoryCat(("B", 5)) },

        [13] = new() { Id=13, Name="Maja Petersson",   Email="maja.petersson@example.com",
            Phone="070-012 34 56",  PhotoUrl="https://randomuser.me/api/portraits/women/80.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(
                ("B", 9, "Bra kontroll i stadsmiljö.", 6)),
            TheoryStepsByCategory=TheoryCat(("B", 10)) },

        [14] = new() { Id=14, Name="Nils Hansson",     Email="nils.hansson@example.com",
            Phone="076-123 45 67",  PhotoUrl="https://randomuser.me/api/portraits/men/64.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 2)),
            TheoryStepsByCategory=TheoryCat(("B", 2)) },

        [15] = new() { Id=15, Name="Olivia Larsson",   Email="olivia.larsson@example.com",
            Phone="070-234 56 79",  PhotoUrl="https://randomuser.me/api/portraits/women/47.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(
        ...
        [16] = new() { Id=16, Name="Pontus Andersson", Email="pontus.andersson@example.com",
            Phone="073-345 67 90",  PhotoUrl="https://randomuser.me/api/portraits/men/38.jpg",
        ...
        [17] = new() { Id=17, Name="Rebecka Johansson",Email="rebecka.johansson@example.com",
            Phone="070-456 78 91",  PhotoUrl="https://randomuser.me/api/portraits/women/25.jpg",
            LicenseCategories=["A1"],
            TrainingStepsByCategory=Cat(("A1", 1)),
            TheoryStepsByCategory=TheoryCat(("A1", 2)) },

        [18] = new() { Id=18, Name="Samuel Nilsson",   Email="samuel.nilsson@example.com",
            Phone="076-567 89 02",  PhotoUrl="https://randomuser.me/api/portraits/men/72.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 10)),
            TheoryStepsByCategory=TheoryCat(("B", 9)) },

        [19] = new() { Id=19, Name="Tilda Svensson",   Email="tilda.svensson@example.com",
            Phone="070-678 90 13",  PhotoUrl="https://randomuser.me/api/portraits/women/62.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(
        ...
        [20] = new() { Id=20, Name="Ulrika Karlsson",  Email="ulrika.karlsson@example.com",
            Phone="073-789 01 24",  PhotoUrl="https://randomuser.me/api/portraits/women/39.jpg",
            LicenseCategories=["B","BE"],
            TrainingStepsByCategory=Cat(
                ("B",  15, "", -1),
        ...
        // ── Id 21-30 ──────────────────────────────────────────────────────────
        [21] = new() { Id=21, Name="Viktor Persson",   Email="viktor.persson@example.com",
            Phone="070-890 12 35",  PhotoUrl="https://randomuser.me/api/portraits/men/5.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 8)),
            TheoryStepsByCategory=TheoryCat(("B", 7)) },

        [22] = new() { Id=22, Name="Wilma Olsson",     Email="wilma.olsson@example.com",
            Phone="076-901 23 46",  PhotoUrl="https://randomuser.me/api/portraits/women/15.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(
                ("B", 3, "Bra grundläggande förståelse.", 1)),
            TheoryStepsByCategory=TheoryCat(("B", 4)) },

        [23] = new() { Id=23, Name="Axel Martinsson",  Email="axel.martinsson@example.com",
            Phone="070-012 34 57",  PhotoUrl="https://randomuser.me/api/portraits/men/49.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 5)),
            TheoryStepsByCategory=TheoryCat(("B", 6)) },

        [24] = new() { Id=24, Name="Bella Claesson",   Email="bella.claesson@example.com",
            Phone="073-123 45 68",  PhotoUrl="https://randomuser.me/api/portraits/women/71.jpg",
            LicenseCategories=["B","AM"],
            TrainingStepsByCategory=Cat(
        ...
        [25] = new() { Id=25, Name="Carl Hedström",    Email="carl.hedstrom@example.com",
            Phone="070-234 56 80",  PhotoUrl="https://randomuser.me/api/portraits/men/22.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 13)),
            TheoryStepsByCategory=TheoryCat(("B", 11)) },

        [26] = new() { Id=26, Name="Diana Forsberg",   Email="diana.forsberg@example.com",
            Phone="076-345 67 91",  PhotoUrl="https://randomuser.me/api/portraits/women/91.jpg",
            LicenseCategories=["AM"],
            TrainingStepsByCategory=Cat(
                ("AM", 4, "Behöver mer tid på moped.", 3)),
            TheoryStepsByCategory=TheoryCat(("AM", 5)) },

        [27] = new() { Id=27, Name="Elias Sundqvist",  Email="elias.sundqvist@example.com",
            Phone="070-456 78 92",  PhotoUrl="https://randomuser.me/api/portraits/men/61.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 9)),
            TheoryStepsByCategory=TheoryCat(("B", 8)) },

        [28] = new() { Id=28, Name="Frida Björk",      Email="frida.bjork@example.com",
            Phone="073-567 89 03",  PhotoUrl="https://randomuser.me/api/portraits/women/53.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(("B", 2)),
            TheoryStepsByCategory=TheoryCat(("B", 3)) },

        [29] = new() { Id=29, Name="Gustav Åberg",     Email="gustav.aberg@example.com",
            Phone="070-678 90 14",  PhotoUrl="https://randomuser.me/api/portraits/men/81.jpg",
            LicenseCategories=["B"],
            TrainingStepsByCategory=Cat(
                ("B", 7, "God rumsuppfattning vid parkering.", 12)),
            TheoryStepsByCategory=TheoryCat(("B", 6)) },

        [30] = new() { Id=30, Name="Hannah Lindgren",  Email="hannah.lindgren@example.com",
            Phone="076-789 01 25",  PhotoUrl="https://randomuser.me/api/portraits/women/29.jpg",
            LicenseCategories=["B"],
